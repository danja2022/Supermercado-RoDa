    ...
    public void actionPerformed(ActionEvent acao) {
         ...
         if (acao.getSource() == telaCadEndereco.getBtNovo()) {
            ...
            telaCadEndereco.ligaDesliga(false);
                ...
                // montar o objeto cidade
                
                // montar o objeto 
               
                //persistir o objeto de endereco criado
                
                telaCadEndereco.ativa(true);
                telaCadEndereco.ligaDesliga(false);
            }
            
            if (telaCadEndereco.getjTextFieldDescricaoLogradouro().getText().trim().equalsIgnoreCase("")) {
                JOptionPane.showMessageDialog(null, "Atributo Logradouro é Obrigatório");
            } else {
                
                Produto produto = new Produto();
                produto.setDescricao(telaCadEndereco.getjTextFieldDescricaoLogradouro().getText());
