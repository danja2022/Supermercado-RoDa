 ...
 * @author Daniel
 */
public class FoBuscaClasses extends javax.swing.JFrame {

    /**
     * Creates new form ModeloBuscas
     */
    public FoBuscaClasses() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FoBuscaClasses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FoBuscaClasses().setVisible(true);
            }
        });
    }
