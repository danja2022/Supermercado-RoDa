...
public final class FoCadastroCliente extends javax.swing.JFrame {
    ...
    public void ligaDesliga (boolean estadoComponente){
       ...
       // }
        ...
        Component[] componentesEnderecos = pnEndereco.getComponents();
        for (Component componentesEndereco : componentesEnderecos){
            if(componentesEndereco instanceof JTextField){
                ((JTextField)componentesEndereco).setText("");
        }
            else if (componentesEndereco instanceof JFormattedTextField){
                ((JFormattedTextField)componentesEndereco).setText ("");
        }
            else if (componentesEndereco instanceof JTextArea){
               ((JTextArea)componentesEndereco).setText ("");     
        }
            else if (componentesEndereco instanceof JComboBox){
                ((JComboBox)componentesEndereco).setSelectedIndex(0);
                    }
          //  else if (componente instanceof JScrollPane){
            //    ((JScrollPane)componente).get
       // }
            componentesEndereco.setEnabled(estadoComponente);
            ...
            .addGroup(pnEnderecoLayout.createSequentialGroup()
                ...
                .addGroup(pnEnderecoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnEnderecoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(tfBairro, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
