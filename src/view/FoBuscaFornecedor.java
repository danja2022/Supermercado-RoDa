 ...
 * @author Daniel
 */
public class FoBuscaFornecedor extends javax.swing.JFrame {

    /**
     * Creates new form ModeloBuscas
     */
    public FoBuscaFornecedor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTablebusca.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Telefone", "Data Cadastro", "Razao Social", "Status"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FoBuscaFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FoBuscaFornecedor().setVisible(true);
            }
        });
    }
