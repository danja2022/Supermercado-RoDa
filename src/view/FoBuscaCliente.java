 ...
 * @author Daniel
 */
public class FoBuscaCliente extends javax.swing.JFrame {

    /**
     * Creates new form ModeloBuscas
     */
    public FoBuscaCliente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FoBuscaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FoBuscaCliente().setVisible(true);
            }
        });
    }
